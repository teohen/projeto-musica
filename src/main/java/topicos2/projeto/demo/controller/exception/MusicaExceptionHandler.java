package topicos2.projeto.demo.controller.exception;
...
@ControllerAdvice
public class MusicaExceptionHandler extends ResponseEntityExceptionHandler {

    private final MessageSource messageSource;

    @Autowired
    public MusicaExceptionHandler(MessageSource messageSource) {
